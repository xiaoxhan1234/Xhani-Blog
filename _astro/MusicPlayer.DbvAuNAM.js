import{o as Ia,a as Ra,i as Na}from"./lifecycle.OxZKTpi0.js";import{$ as Wa,a7 as Oa,aJ as Ya,aK as qa,aL as $e,u as Ie,aM as Ka,ac as Re,aN as Ua,U as Ne,aO as gt,a5 as Ha,aP as Xa,c as it,f as tt,a as W,p as Ga,b as Ja,s as u,m as B,ak as K,g as t,d as vt,h as v,e as s,r as i,n as Va,t as Pt}from"./template.BjuiTig8.js";import{a as Qa,s as J}from"./render.BmKFLAcy.js";import{i as z}from"./if.D5h-4qKe.js";import{e as Za,i as tr}from"./each.DZqPV-mU.js";import{a as O,s as st,c as Se}from"./props.CCwlc0S8.js";import{e as y}from"./utils.D-kq7FMU.js";import{I as f}from"./Icon.CVSAqIrG.js";import{m as xt}from"./config.DAQS4Fa6.js";import{I as er}from"./zh_TW.DrrWwPS4.js";import{i as ar}from"./translation.CZWIIv5k.js";const rr=()=>performance.now(),V={tick:o=>requestAnimationFrame(o),now:()=>rr(),tasks:new Set};function We(){const o=V.now();V.tasks.forEach(r=>{r.c(o)||(V.tasks.delete(r),r.f())}),V.tasks.size!==0&&V.tick(We)}function ir(o){let r;return V.tasks.size===0&&V.tick(We),{promise:new Promise(b=>{V.tasks.add(r={c:o,f:b})}),abort(){V.tasks.delete(r)}}}function zt(o,r){Re(()=>{o.dispatchEvent(new CustomEvent(r))})}function sr(o){if(o==="float")return"cssFloat";if(o==="offset")return"cssOffset";if(o.startsWith("--"))return o;const r=o.split("-");return r.length===1?r[0]:r[0]+r.slice(1).map(b=>b[0].toUpperCase()+b.slice(1)).join("")}function je(o){const r={},b=o.split(";");for(const F of b){const[_,p]=F.split(":");if(!_||p===void 0)break;const $=sr(_.trim());r[$]=p.trim()}return r}const nr=o=>o;function lr(o,r,b,F){var _=(o&Ka)!==0,p="both",$,w=r.inert,L=r.style.overflow,d,g;function P(){return Re(()=>$??=b()(r,F?.()??{},{direction:p}))}var A={is_global:_,in(){r.inert=w,zt(r,"introstart"),d=ae(r,P(),g,1,()=>{zt(r,"introend"),d?.abort(),d=$=void 0,r.style.overflow=L})},out(j){r.inert=!0,zt(r,"outrostart"),g=ae(r,P(),d,0,()=>{zt(r,"outroend"),j?.()})},stop:()=>{d?.abort(),g?.abort()}},M=Wa;if((M.transitions??=[]).push(A),Qa){var S=_;if(!S){for(var c=M.parent;c&&(c.f&Oa)!==0;)for(;(c=c.parent)&&(c.f&Ya)===0;);S=!c||(c.f&qa)!==0}S&&$e(()=>{Ie(()=>A.in())})}}function ae(o,r,b,F,_){var p=F===1;if(Ua(r)){var $,w=!1;return Ne(()=>{if(!w){var j=r({direction:p?"in":"out"});$=ae(o,j,b,F,_)}}),{abort:()=>{w=!0,$?.abort()},deactivate:()=>$.deactivate(),reset:()=>$.reset(),t:()=>$.t()}}if(b?.deactivate(),!r?.duration)return _(),{abort:gt,deactivate:gt,reset:gt,t:()=>F};const{delay:L=0,css:d,tick:g,easing:P=nr}=r;var A=[];if(p&&b===void 0&&(g&&g(0,1),d)){var M=je(d(0,1));A.push(M,M)}var S=()=>1-F,c=o.animate(A,{duration:L,fill:"forwards"});return c.onfinish=()=>{c.cancel();var j=b?.t()??1-F;b?.abort();var x=F-j,et=r.duration*Math.abs(x),at=[];if(et>0){var I=!1;if(d)for(var m=Math.ceil(et/16.666666666666668),k=0;k<=m;k+=1){var a=j+x*P(k/m),Q=je(d(a,1-a));at.push(Q),I||=Q.overflow==="hidden"}I&&(o.style.overflow="hidden"),S=()=>{var U=c.currentTime;return j+x*P(U/et)},g&&ir(()=>{if(c.playState!=="running")return!1;var U=S();return g(U,1-U),!0})}c=o.animate(at,{duration:et,fill:"forwards"}),c.onfinish=()=>{S=()=>F,g?.(F,1-F),_()}},{abort:()=>{c&&(c.cancel(),c.effect=null,c.onfinish=gt)},deactivate:()=>{_=gt},reset:()=>{F===0&&g?.(1,0)},t:()=>S()}}function De(o,r){return o===r||o?.[Xa]===r}function Pe(o={},r,b,F){return $e(()=>{var _,p;return Ha(()=>{_=p,p=[],Ie(()=>{o!==b(...p)&&(r(o,...p),_&&De(b(..._),o)&&r(null,..._))})}),()=>{Ne(()=>{p&&De(b(...p),o)&&r(null,...p)})}}),o}function ze(o){return function(...r){var b=r[0];return b.stopPropagation(),o?.apply(this,r)}}function or(o){const r=o-1;return r*r*r+1}function ur(o,{delay:r=0,duration:b=400,easing:F=or,axis:_="y"}={}){const p=getComputedStyle(o),$=+p.opacity,w=_==="y"?"height":"width",L=parseFloat(p[w]),d=_==="y"?["top","bottom"]:["left","right"],g=d.map(x=>`${x[0].toUpperCase()}${x.slice(1)}`),P=parseFloat(p[`padding${g[0]}`]),A=parseFloat(p[`padding${g[1]}`]),M=parseFloat(p[`margin${g[0]}`]),S=parseFloat(p[`margin${g[1]}`]),c=parseFloat(p[`border${g[0]}Width`]),j=parseFloat(p[`border${g[1]}Width`]);return{delay:r,duration:b,easing:F,css:x=>`overflow: hidden;opacity: ${Math.min(x*20,1)*$};${w}: ${x*L}px;padding-${d[0]}: ${x*P}px;padding-${d[1]}: ${x*A}px;margin-${d[0]}: ${x*M}px;margin-${d[1]}: ${x*S}px;border-${d[0]}-width: ${x*c}px;border-${d[1]}-width: ${x*j}px;min-${w}: 0`}}var cr=vt('<div class="fixed bottom-20 right-4 z-[60] max-w-sm"><div class="bg-red-500 text-white px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 animate-slide-up"><!> <span class="text-sm flex-1"> </span> <button class="text-white/80 hover:text-white transition-colors"><!></button></div></div>'),dr=vt('<div class="flex space-x-0.5"><div class="w-0.5 h-3 bg-white rounded-full animate-pulse"></div> <div class="w-0.5 h-4 bg-white rounded-full animate-pulse" style="animation-delay: 150ms;"></div> <div class="w-0.5 h-2 bg-white rounded-full animate-pulse" style="animation-delay: 300ms;"></div></div>'),vr=vt('<span class="text-sm text-[var(--content-meta)]"></span>'),fr=vt('<div role="button" tabindex="0"><div class="w-6 h-6 flex items-center justify-center"><!></div> <div class="w-10 h-10 rounded-lg overflow-hidden bg-[var(--btn-regular-bg)] flex-shrink-0"><img class="w-full h-full object-cover"/></div> <div class="flex-1 min-w-0"><div> </div> <div> </div></div></div>'),pr=vt('<div class="playlist-panel float-panel fixed bottom-20 right-4 w-80 max-h-96 overflow-hidden z-50"><div class="playlist-header flex items-center justify-between p-4 border-b border-[var(--line-divider)]"><h3 class="text-lg font-semibold text-90"> </h3> <button class="btn-plain w-8 h-8 rounded-lg"><!></button></div> <div class="playlist-content overflow-y-auto max-h-80"></div></div>'),mr=vt(`<!> <div><div role="button" tabindex="0" aria-label="显示音乐播放器"><!></div> <div role="button" tabindex="0" aria-label="展开音乐播放器"><div class="flex items-center gap-3 cursor-pointer"><div class="cover-container relative w-12 h-12 rounded-full overflow-hidden"><img alt="封面"/> <div class="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity"><!></div></div> <div class="flex-1 min-w-0"><div class="text-sm font-medium text-90 truncate"> </div> <div class="text-xs text-50 truncate"> </div></div> <div class="flex items-center gap-1"><button class="btn-plain w-8 h-8 rounded-lg flex items-center justify-center" title="隐藏播放器"><!></button> <button class="btn-plain w-8 h-8 rounded-lg flex items-center justify-center"><!></button></div></div></div> <div><div class="flex items-center gap-4 mb-4"><div class="cover-container relative w-16 h-16 rounded-full overflow-hidden flex-shrink-0"><img alt="封面"/></div> <div class="flex-1 min-w-0"><div class="song-title text-lg font-bold text-90 truncate mb-1"> </div> <div class="song-artist text-sm text-50 truncate"> </div> <div class="text-xs text-30 mt-1"> </div></div> <div class="flex items-center gap-1"><button class="btn-plain w-8 h-8 rounded-lg flex items-center justify-center" title="隐藏播放器"><!></button> <button class="btn-plain w-8 h-8 rounded-lg flex items-center justify-center"><!></button></div></div> <div class="progress-section mb-4"><div class="progress-bar flex-1 h-2 bg-[var(--btn-regular-bg)] rounded-full cursor-pointer" role="slider" tabindex="0" aria-label="播放进度" aria-valuemin="0" aria-valuemax="100"><div class="h-full bg-[var(--primary)] rounded-full transition-all duration-100"></div></div></div> <div class="controls flex items-center justify-center gap-2 mb-4"><button><!></button> <button class="btn-plain w-10 h-10 rounded-lg"><!></button> <button><!></button> <button class="btn-plain w-10 h-10 rounded-lg"><!></button> <button><!></button></div> <div class="bottom-controls flex items-center gap-2"><button class="btn-plain w-8 h-8 rounded-lg"><!></button> <div class="flex-1 h-2 bg-[var(--btn-regular-bg)] rounded-full cursor-pointer" role="slider" tabindex="0" aria-label="音量控制" aria-valuemin="0" aria-valuemax="100"><div class="h-full bg-[var(--primary)] rounded-full transition-all duration-100"></div></div> <button><!></button></div></div> <!></div> <style>.orb-player {
	position: relative;
